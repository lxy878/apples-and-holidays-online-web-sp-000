...
def all_winter_holiday_supplies(holiday_hash)
  ...
  supplies = holiday_hash[:winter].collect {|holidays, supply_array| supply_array}
  supplies.flatten
end
...
def name_fix(name)
  ...
  capital_words = words.collect {|word| word.capitalize}
  capital_words.join(" ")
end
...
def all_holidays_with_bbq(holiday_hash)
  ...
  holiday_hash.each do |season, holidays_data|
    holidays_data.each do |holiday, supply_array|
